            ...
            if (bitmap != null) {
                try {
                    ...
                    if (size > (4 * 1024 * 1024)) {
                        ...
                        //imageProfile.setScaleType(ImageView.ScaleType.FIT_CENTER);
                        byte[] byteArray = byteArrayOutputStream.toByteArray();
                        filePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/vkc" + ".jpg";
...
//                        File tempFile = new File(imageUri.getPath());
                        ...
                        if (Build.VERSION.SDK_INT >= 27) {
                            selectedImage = FileProvider.getUriForFile(
                                    ProfileActivity.this,
                                    "com.vkc.bluetyga.provider", //(use your app signature + ".provider" )
                                    tempFile);
                        }
                        else
                        {
