...
public interface VKCUrlConstants {
    ...
    // Dev URL
    //public String BASE_URL = "http://dev.mobatia.com/vkc_apparel/";

    // Live URL
    public String BASE_URL = "https://mobile.walkaroo.in/vkc_apparel/";
    //public String BASE_URL = "http://54.84.5.69/vkc/";
